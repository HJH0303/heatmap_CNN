...
from my_model.my_model_CNN_heat_g import CNN_heat
...
def main():
    ...
    # parameters
    PATH_weight="/home/aims/2024/weights/heatmap/grid_heatmap/15.pth"
    DEVICE = '0'
    blue_color = (255, 0, 0)
    red_color = (0, 0, 255)
    center_axis=340
    ...
    while key != 113:  # for 'q' key
        ...
        if err == sl.ERROR_CODE.SUCCESS:
            ...
            heatmap = np.zeros((376, 672), dtype=np.float32)
            prev_track = track
