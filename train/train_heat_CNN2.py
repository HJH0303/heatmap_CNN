...
class EarlyStopping:
    ...
    def save_checkpoint(self, val_loss, model):
        path = "/home/lcy/Desktop/junhee/heatmap/weights/grid_heatmap/best.pth" 
...
def saveModel(net): 
    path = "/home/lcy/Desktop/junhee/heatmap/weights/grid_heatmap/final.pth" 
...
if __name__ == "__main__":
    ...
    training_epochs = 100 # Total number of epochs
    trainingEpoch_loss = []
    valid_Epoch_loss = []
    early_stopping = EarlyStopping(patience=5, verbose=True)
    stop_epoch = 1
    check_path1= "/home/lcy/Desktop/junhee/heatmap/weights/grid_heatmap" 
    max_val_acc = 0
